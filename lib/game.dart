...
import 'dart:math';
import 'package:legal_wordle_words/legal_wordle_words.dart'; ///Added to get Wordle words - KLB
...
/// *Removed to use full wordle list -KLB* Words that can be chosen as the hidden word.
///const List<String> legalWords = ['aback', 'abase', 'abate', 'abbey', 'abbot'];

/// *Removed to use full wordle list -KLB* Additional words accepted as guesses beyond those in [legalWords].
